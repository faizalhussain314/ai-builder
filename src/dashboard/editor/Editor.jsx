...
const Editor = () => {
  // Define your static HTML content here
...
#it00l {
  ...
  const [htmlContent, setHtmlContent] = useState(staticHtmlContent);

  const handleSave = (editedContent) => {
    // Send edited HTML content to backend or handle it as needed
    console.log("Edited HTML content:", editedContent);
    // Here you can implement logic to save the content if required
  };
