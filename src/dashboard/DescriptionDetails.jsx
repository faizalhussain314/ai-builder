...
function DescriptionDetails() {
  ...
  const handleType = async () => {
    ...
    const prompt = `write a description for my name ${bussiness} in 54 words? if bussiness is not given then write for any company you like`;
    try {
              ...
              <div className="h-screen">
                <div className="space-y-5 px-10 lg:px-16  mt-12">
                  ...
                  <p className="text-base font-normal leading-6 text-app-text">
                    Please enter what you would like the website to be called.
                  </p>
                </div>
                          ...
                          <div className="flex relative items-center">
                            <div className="w-full">
                              <textarea
                                ...
                                value={temp}
                                className="h-36 p-4 w-full placeholder:zw-placeholder zw-input rounded-md border outline-none focus:shadow-input-focus shadow-sm border-app-border focus:border-palatinate-blue-600 "
                                name=""
                                id=""
                              />
                            </div>
                ...
                <div className="sticky bottom-0 pb-8 bg-app-light-background pt-3 px-10 lg:px-16 xl:px-36 z-50 bg-white">
                  <div className="flex xs:items-center items-start justify-between">
                    <div className="flex flex-row xs:flex-row xs:items-center items-start gap-x-10 gap-y-10 xs:gap-y-0 flex-wrap">
                      <button
                        onClick={nextStep}
                        className="hover:opacity-70  min-w-[142px]  inline-flex items-center justify-center    bg-palatinate-blue-600 hover:bg-palatinate-blue-600  text-white pl-[25px] pr-[23px] py-[13px]  h-[50px]  rounded-md zw-btn-base shadow-sm  focus:outline-none disabled:opacity-25 transition ease-in-out duration-150"
                      >
                      ...
                      <button
                        ...
                        className="group  flex items-center justify-center gap-2 rounded-md focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 transition duration-150 ease-in-out disabled:opacity-25 disabled:cursor-not-allowed text-app-secondary bg-app-light-background border border-app-secondary shadow-sm py-2.5 text-sm font-semibold leading-5 h-[50px] px-6"
                      >
                        Previous Step
                      </button>
                    </div>
